...
class PrintMessageBehaviour(HelloWorldABCIBaseBehaviour, ABC):
    ...
    def async_act(self) -> Generator:
        ...
        printed_message = f"Agent {self.context.agent_name} (address {self.context.agent_address}) in period {self.synchronized_data.period_count} says: {message} {self.params.owner}"
